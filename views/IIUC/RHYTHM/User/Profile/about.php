...
<div class="container" style="margin-top: 50px;padding-right: 50px">
<h1 style="text-align: center">Doctor Management System </h1>

</div>
<div class="container">
<p><img src="../../../../../resources/image/about image.jpg" width="100%" height="210px" ></p>
</div>
<div class="container">
<h3>One of the Best and Most Accepted Doctors  Management Systems Industry-Wide</h3>
<p style="text-align: justify;text-decoration: none;font-weight: bold">RHYTHM brings to you the <strong>doctor management software</strong> that is set to transform the way healthcare centres operate. With the help of this doctor management software, the medical professionals can automate various day-to-day administrative and management tasks of their medical offices. Keeping a constant track of aspects such as inventory, patients’ appointments and scheduling, prescriptions etc would now just be a click away.</p>
<p style="text-align: justify;text-decoration: none;font-weight: bold">Our <strong>Doctor software </strong> comes with a set of unique features and software modules that empower the doctors and medical professionals to manage their respective healthcare units optimally. The use of a Patients Management System such software has become imperative in today’s scenario, considering the increased burden of non-core chamber or hospital tasks on the medical fraternity.</p>
<p style="text-align: justify;text-decoration: none;font-weight: bold">The need for such healthcare software systems cannot be stressed more, citing the amount of time and money they save in the process of handling a plethora of chamber related activities. Our software services ensure that the medical practitioners focus on their primary objectives of providing timely and quality medical treatment to the patients in an unhindered manner.</p>
<hr />
<h3>Doctor  Management System Software Features</h3>
    ...
    <ul class="checks">
        ...
        <li>Availability: 24/7 Accessibility<br />
            (Restricted access and availability also possible)</li>
    </ul>
</div>
<div class="one_half last">
    <ul class="checks">
        <li>Centralized Records</li>
        <li>Unlimited chamber Setup</li>
...
<div class="one_half">
    <ul>
        ...
        <li>Patient Visit Details</li>
        <li>Chember Billing and Payment Management</li>
