<?php
$gmailAddress = "teamrhythmIIUC@gmail.com";
$gmailPassword = "teamrhythmIIUC6";
...
if(isset($_POST['email'])) {
    ...
    $message =  "Please click this link to reset your password: 
       http://$myHostIP/Doctor_Management_System/views/IIUC/RHYTHM/User/Profile/resetpassword.php?email=".$_POST['email']."&code=".$singleUser->password;
